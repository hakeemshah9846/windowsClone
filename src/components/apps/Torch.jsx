        ...
        <main className="cursor-custom w-full h-full">
            ...
            { showTorch && (
                ...
                <motion.div style={{
                    ...
                    pointerEvents : "none",
                    visibility : "visible",
                    background : "radial-gradient(circle at 50% 50%, rgba(20, 20, 20, 0) 0%, rgba(20, 20, 20, 0.4) 1.25%, rgba(20, 20, 20, 0.6) 1.5%, rgba(20, 20, 20, 0.9) 1.875%, rgba(20, 20, 20, 1) 2.5%, rgba(20, 20, 20, 1) 100%)",
                }} className="text-primary"></motion.div>

                <div className="w-full h-screen absolute top-0 bg-transparent z-50">
                    <img src="images/apps/switch.png" alt="switch" className="h-10 w-10 z-50 absolute hover:cursor-pointer" style={{top : randomPosition.top, left : randomPosition.left}} 
                    onClick={() => {
                        playSound();
                        setInput(null);
                    }} 
